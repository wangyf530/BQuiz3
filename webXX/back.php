    ...
    <div id="main">
        ...
        <div id="mm">
            <div class="ct a rb" style="position:relative; width:101.5%; left:-1%; padding:3px; top:-9px;">
                <!-- 去掉admin 把rr/vv改成poster/movie 創建檔案 tit.php/go.php等-->
            ...
            <!-- 切版 去掉中間移動到back/main.php 其他用include方式(從index複製 front->back 即可) -->
            <?php
              $do = $_GET['do']??'main';
              $file = "./back/$do.php";
              if (file_exists($file)){
        ...
        <!-- 改年份 -->
        <div id="bo"> ©Copyright 2010~2025 ABC影城 版權所有 </div>
    </div>
</body>
